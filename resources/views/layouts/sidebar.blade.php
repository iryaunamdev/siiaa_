<aside class ="w-64" aria-label="Sidebar">
    <div class="overflow-y-auto py-4 px-3 rounded">
        <ul class="space-y-2">
            <li :hover="request()->routeIs('comisiones')">
                <a href="{{ route('comisiones') }}" class="flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 ">
                    <i class="fa-duotone fa-arrows-down-to-people fa-xl"></i>
                    <span class="ml-3">Comisiones</span>
                </a>
            </li>
        </ul>
        {{--
